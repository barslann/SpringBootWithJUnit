...
public class testsIT {
    ...
    public void getAuthorNameBooksTest() throws JSONException {
        String expected = "[{\"id\":\"test123\",\"bookName\":\"spring\",\"isbn\":\"test\",\"author\":\"coderman\",\"aisle\":123},{\"id\":\"test124\",\"bookName\":\"react\",\"isbn\":\"test\",\"author\":\"coderman\",\"aisle\":124},{\"id\":\"test125\",\"bookName\":\"selenium\",\"isbn\":\"test\",\"author\":\"coderman\",\"aisle\":125}]";
    ...
    @Test
    public void addbookIntegrationTest() throws JSONException {
        TestRestTemplate testRestTemplate = new TestRestTemplate();
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);
        HttpEntity<Book> request = new HttpEntity<Book>(buildABook(),headers);
        ResponseEntity<String> responseEntity = testRestTemplate.postForEntity("http://localhost:9090/api/addbook/author?authorname=coderman",request,String.class);
        System.out.println("Status code: " + responseEntity.getStatusCode());
        System.out.println("Body: " + responseEntity.getBody());
